...
export type ApplicationQuestionItemsDynamicZone = any;
...
export type GenericMorph = ComponentApplicationCodeblock | ComponentApplicationTweet | ComponentCommonButton | ComponentCommonTextBlock | ComponentMoviePoster | UploadFile | UploadFolder | AwesomeHelpHelp | I18NLocale | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser | EzformsSubmission | EzformsRecipient | GraphsBuilderGraph | About | ApplicationField | ApplicationQuestion | ApplicationSession | ComingSoon | Homepage | Imprint | KnownUrl | Serie | Video;
